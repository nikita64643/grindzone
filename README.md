...
```bash
git clone https://github.com/nikita64643/grindzone.git
cd grindzone
```

После клонирования нужно установить Paper/server.jar, плагины и Java (см. скрипты установки). Миры, jar-файлы и кэш исключены из репозитория.
