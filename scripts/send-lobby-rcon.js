/**
 * Send RCON commands to lobby server.
 * Usage: node scripts/send-lobby-rcon.js [command1] [command2] ...
 * Example: node scripts/send-lobby-rcon.js "citizens reload" "npc spawn 1"
 *
 * Default (no args): citizens reload, npc spawn 1
 */
...
const PORT = 25575;
const PASS = "minecruft_lobby_rcon";
